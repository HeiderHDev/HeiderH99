<h2 align="left">¡Hola! Soy Heider Hernandez 👋</h2>
...
<p align="left">const HeiderHDev = {<br>  pronouns: "he" | "him",<br>  code: [Javascript, Typescript, HTML, CSS],<br>  tools: [Angular],<br>  learning: [AWS]<br>}</p>
